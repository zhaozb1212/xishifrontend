...
(function () {
    ...
    var a = function () {
        ...
        return a
    }, b = "https://web-ubt.ele.me/par.gif", c = "https://web-ubt.ele.me/tracking.gif", d = function (a, b) {
    ...
    a.put("carousel-indicators.html", '<div class="rn-carousel-indicator">\n<span ng-repeat="slide in slides" ng-class="{active: $index==index}" ng-click="goToSlide($index)">ก๑</span></div>')
}]), function () {
    "use strict";
